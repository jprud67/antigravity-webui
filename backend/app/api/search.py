...
def search_fts(
    ...
    role: str | None = Query(None, description="Filtrer par rôle (user, assistant, system)"),
    session_id: str | None = Query(None, description="Filtrer par identifiant de conversation"),
    project: str | None = Query(None, description="Filtrer par projet"),

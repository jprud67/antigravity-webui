        ...
        <div className="p-4 sm:p-6 border-b border-slate-200 dark:border-slate-800 space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">
                    Store de Serveurs MCP Clés en Main
                  </h2>
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/15 text-emerald-500 border border-emerald-500/30 flex items-center gap-1 font-semibold">
                    <ShieldCheck className="w-3 h-3" /> Officiel Hermes / Nous
                  </span>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Plus de 70 connecteurs d'outils certifiés prêts à l'emploi en 1 clic
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Rechercher parmi 70+ serveurs MCP (Supabase, Sentry, Stripe, Notion, Docker...)"
                value={query}
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-200 dark:border-slate-800">
                ...
                >
                  ...
                  <span>{installing ? 'Installation...' : 'Activer maintenant'}</span>
                </button>
              </div>
            </div>
          </div>

  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-agyLoopGlow`} x1="15%" y1="90%" x2="85%" y2="20%">
        ...
        <linearGradient id={`${id}-agyBlueSegment`} x1="50%" y1="40%" x2="90%" y2="100%">
          <stop offset="0%" stopColor="#38BDF8" />
          <stop offset="60%" stopColor="#2563EB" />
          <stop offset="100%" stopColor="#1D4ED8" />
        </linearGradient>

        <linearGradient id={`${id}-agyRedSegment`} x1="40%" y1="20%" x2="100%" y2="40%">
        ...
        <linearGradient id={`${id}-agyGreenSegment`} x1="60%" y1="20%" x2="0%" y2="90%">
        ...
        <filter id={`${id}-agyAmbientGlow`} x="-15%" y="-15%" width="130%" height="130%">
      ...
      <path
        ...
        fill={`url(#${id}-agyLoopGlow)`}
        filter={`url(#${id}-agyAmbientGlow)`}
      />

      {/* Clipped luminous gradient intersections */}
      <g clipPath={`url(#${id}-agyLoopContour)`}>
        {/* Top-Right Red / Orange Burst */}
        <circle cx="85" cy="38" r="32" fill={`url(#${id}-agyRedSegment)`} />
        {/* Left Green / Cyan Burst */}
        <circle cx="24" cy="55" r="36" fill={`url(#${id}-agyGreenSegment)`} />
        {/* Top Yellow Apex Burst */}
        <circle cx="56" cy="22" r="18" fill="#FACC15" />
        {/* Bottom Right Blue/Cyan Base Burst */}
        <circle cx="78" cy="85" r="30" fill={`url(#${id}-agyBlueSegment)`} />
        {/* Crossing Waist Glow */}

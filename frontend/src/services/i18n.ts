...
export const UI_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  abort_rebase_btn: {
    en: 'Abort (git rebase --abort)',
    fr: 'Abandonner (git rebase --abort)',
    es: 'Abortar (git rebase --abort)',
    de: 'Abbrechen (git rebase --abort)',
  },
  abort_rebase_title: {
    en: 'Abort Rebase',
    fr: 'Abandonner le Rebase',
    es: 'Abortar Rebase',
    de: 'Rebase abbrechen',
  },
  bookmark_delete_error: {
    en: 'Failed to delete bookmark',
    fr: 'Erreur lors de la suppression du favori',
    es: 'Error al eliminar el marcador',
    de: 'Fehler beim Löschen des Lesezeichens',
  },
  bookmark_save_error: {
    en: 'Failed to save bookmark',
    fr: 'Erreur lors de l\'enregistrement du favori',
    es: 'Error al guardar el marcador',
    de: 'Fehler beim Speichern des Lesezeichens',
  },
  branch_create_error: {
    en: 'Failed to create branch',
    fr: 'Erreur lors de la création de la branche',
    es: 'Error al crear la rama',
    de: 'Fehler beim Erstellen des Branches',
  },
  branch_delete_error: {
    en: 'Failed to delete branch',
    fr: 'Erreur lors de la suppression de la branche',
    es: 'Error al eliminar la rama',
    de: 'Fehler beim Löschen des Branches',
  },
  branch_merge_error: {
    en: 'Failed to merge branch',
    fr: 'Erreur lors de la fusion',
    es: 'Error al fusionar la rama',
    de: 'Fehler beim Zusammenführen des Branches',
  },
  branch_rename_error: {
    en: 'Failed to rename branch',
    fr: 'Erreur lors du renommage',
    es: 'Error al renombrar la rama',
    de: 'Fehler beim Umbenennen des Branches',
  },
  cherry_pick_btn: {
    en: 'Apply (Cherry-pick)',
    fr: 'Appliquer (Cherry-pick)',
    es: 'Aplicar (Cherry-pick)',
    de: 'Anwenden (Cherry-pick)',
  },
  cherry_pick_error: {
    en: 'Failed to cherry-pick commit',
    fr: 'Erreur lors du cherry-pick',
    es: 'Error al realizar cherry-pick',
    de: 'Fehler beim Cherry-Pick',
  },
  cherry_pick_title: {
    en: 'Cherry-pick commit',
    fr: 'Cherry-pick commit',
    es: 'Cherry-pick commit',
    de: 'Commit cherry-picken',
  },
  close_all_tabs_confirm: {
    en: 'Multiple tabs contain unsaved changes. Close all anyway?',
    fr: 'Plusieurs onglets comportent des modifications non enregistrées. Tout fermer quand même ?',
    es: 'Varias pestañas tienen cambios sin guardar. ¿Cerrar todas de todos modos?',
    de: 'Mehrere Tabs enthalten ungespeicherte Änderungen. Trotzdem alle schließen?',
  },
  close_other_tabs_confirm: {
    en: 'Some other tabs contain unsaved changes. Close other tabs anyway?',
    fr: 'Certains onglets comportent des modifications non enregistrées. Fermer les autres onglets quand même ?',
    es: 'Otras pestañas contienen cambios sin guardar. ¿Cerrar las demás pestañas de todos modos?',
    de: 'Einige andere Tabs enthalten ungespeicherte Änderungen. Andere Tabs trotzdem schließen?',
  },
  close_tabs_right_confirm: {
    en: 'Some tabs to the right contain unsaved changes. Close them anyway?',
    fr: 'Certains onglets à droite comportent des modifications non enregistrées. Les fermer quand même ?',
    es: 'Algunas pestañas a la derecha contienen cambios sin guardar. ¿Cerrarlas de todos modos?',
    de: 'Einige Tabs rechts enthalten ungespeicherte Änderungen. Trotzdem schließen?',
  },
  compact_fail_error: {
    en: 'Failed to compact conversation',
    fr: 'Erreur lors du compactage de la conversation',
    es: 'Error al compactar la conversación',
    de: 'Fehler beim Komprimieren der Konversation',
  },
  confirm_abort_rebase: {
    en: 'Do you want to abort the current rebase and restore the branch to its initial state?',
    fr: 'Voulez-vous abandonner le rebase en cours et restaurer la branche dans son état initial ?',
    es: '¿Desea abortar el rebase en curso y restaurar la rama a su estado inicial?',
    de: 'Möchten Sie das laufende Rebase abbrechen und den Branch in den ursprünglichen Zustand zurückversetzen?',
  },
  confirm_cherry_pick_commit: {
    en: 'Do you want to apply commit \'{0} : {1}\' onto the active branch?',
    fr: 'Voulez-vous appliquer le commit « {0} : {1} » sur la branche active ?',
    es: '¿Desea aplicar el commit « {0} : {1} » en la rama activa?',
    de: 'Möchten Sie den Commit „{0} : {1}“ auf den aktiven Branch anwenden?',
  },
  conflict_resolve_error: {
    en: 'Failed to resolve conflict',
    fr: 'Erreur lors de la résolution du conflit',
    es: 'Error al resolver el conflicto',
    de: 'Fehler beim Auflösen des Konflikts',
  },
  continue_rebase_btn: {
    en: 'Continue rebase',
    fr: 'Continuer le rebase',
    es: 'Continuar rebase',
    de: 'Rebase fortsetzen',
  },
  copy_notes_failed: {
    en: 'Failed to copy notes',
    fr: 'Échec de la copie des notes',
    es: 'Error al copiar las notas',
    de: 'Notizen konnten nicht kopiert werden',
  },
  inaccessible: {
    en: 'Inaccessible',
    fr: 'Inaccessible',
  ...
  preview_diff_error: {
    en: 'Failed to preview diff',
    fr: 'Erreur lors de la prévisualisation',
    es: 'Error al previsualizar la diferencia',
    de: 'Fehler bei der Diff-Vorschau',
  },
  rebase_abort_error: {
    en: 'Failed to abort rebase',
    fr: 'Erreur lors de l\'abandon du rebase',
    es: 'Error al abortar el rebase',
    de: 'Fehler beim Abbrechen des Rebase',
  },
  rebase_continue_error: {
    en: 'Failed to continue rebase',
    fr: 'Erreur lors de la poursuite du rebase',
    es: 'Error al continuar el rebase',
    de: 'Fehler beim Fortsetzen des Rebase',
  },
  release_notes_copied_clipboard: {
    en: 'Release notes copied to clipboard',
    fr: 'Notes de version copiées dans le presse-papier',
    es: 'Notas de la versión copiadas al portapapeles',
    de: 'Versionshinweise in die Zwischenablage kopiert',
  },
  replace_all_in_file_confirm: {
    en: 'Replace all occurrences ({0}) in {1} with "{2}"?',
    fr: 'Remplacer toutes les occurrences ({0}) dans {1} par "{2}" ?',
    es: '¿Reemplazar todas las coincidencias ({0}) en {1} con "{2}"?',
    de: 'Alle Vorkommnisse ({0}) in {1} durch „{2}“ ersetzen?',
  },
  replace_global_error: {
    en: 'Global replacement error',
    fr: 'Erreur lors du remplacement global',
    es: 'Error en el reemplazo global',
    de: 'Fehler beim globalen Ersetzen',
  },
  replace_occurrence_error: {
    en: 'Replacement error',
    fr: 'Erreur lors du remplacement',
    es: 'Error al reemplazar',
    de: 'Fehler beim Ersetzen',
  },
  revert_tab_confirm: {
    en: 'Do you want to discard all unsaved changes for « {0} » and restore the version from disk?',
    fr: 'Voulez-vous annuler toutes les modifications non enregistrées pour « {0} » et rétablir le contenu du disque ?',
    es: '¿Desea descartar todos los cambios sin guardar de « {0} » y restaurar la versión del disco?',
    de: 'Möchten Sie alle ungespeicherten Änderungen für „{0}“ verwerfen und die Version von der Festplatte wiederherstellen?',
  },
  search_error: {
    en: 'Search error',
  ...
  stash_apply_error: {
    en: 'Failed to apply stash',
    fr: 'Erreur lors de l\'application du stash',
    es: 'Error al aplicar el stash',
    de: 'Fehler beim Anwenden des Stash',
  },
  stash_clear_error: {
    en: 'Failed to clear stashes',
    fr: 'Erreur lors du vidage des stashes',
    es: 'Error al vaciar los stashes',
    de: 'Fehler beim Leeren der Stashes',
  },
  stash_create_error: {
    en: 'Failed to create stash',
    fr: 'Erreur lors de la création du stash',
    es: 'Error al crear el stash',
    de: 'Fehler beim Erstellen des Stash',
  },
  stash_delete_error: {
    en: 'Failed to delete stash',
    fr: 'Erreur lors de la suppression du stash',
    es: 'Error al eliminar el stash',
    de: 'Fehler beim Löschen des Stash',
  },
  stash_pop_error: {
    en: 'Failed to pop stash',
    fr: 'Erreur lors du dépilage du stash',
    es: 'Error al extraer (pop) el stash',
    de: 'Fehler beim Poppen des Stash',
  },
  switch_branch_error: {
    en: 'Failed to switch branch',
    fr: 'Erreur lors de la bascule de branche',
    es: 'Error al cambiar de rama',
    de: 'Fehler beim Wechseln des Branches',
  },
  the_folder: {
    en: 'the folder',
    fr: 'le dossier',
  ...
  unsaved_changes_confirm: {
    en: 'File \'{0}\' has unsaved changes. Close anyway?',
    fr: 'Le fichier « {0} » a des modifications non enregistrées. Fermer quand même ?',
    es: 'El archivo « {0} » tiene cambios sin guardar. ¿Cerrar de todos modos?',
    de: 'Die Datei „{0}“ hat ungespeicherte Änderungen. Trotzdem schließen?',
  },
};

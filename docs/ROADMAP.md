...
### 📌 Sprint 20 (v0.2.24 – Prochaine étape)
| Milestone | Description | Owner | Target | Status |
|---|---|---|---|---|
...
| **Option C : Global Workspace Task Runner & Pipeline Orchestrator** | Détection automatique des scripts de build / test (`npm`, `pytest`, `cargo`, `make`), lanceur de tâches unifié avec exécution parallèle/séquentielle, inspection de statut et journalisation en temps réel. | DevOps / IDE | 2027‑02‑23 | ⏳ Planned |
